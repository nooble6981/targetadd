...
<div id="ulpb_dash_container">
	<h2 style="font-size:20px; font-weight: normal;">Landing Page Dashboard</h2>
	...
	<div class="tabs">
		...
		<div class="tab-content">
			<div id="tab1" class="tab active">
				<h2>Welcome to Ultimate Landing Page by Web Settler</h2>
				<p>Thank you for choosing the Ultimate Landing Page plugin and welcome to the community. Find some useful information below and learn how to create beautiful Landing Pages in minutes.</p>
				<br>
				<h3>Getting Started - Create Your First Landing Page</h3>
        <br>
        <a href="<?php echo admin_url('post-new.php?post_type=subscribe_me_forms'); ?>" target="_blank" style="font-size:14px; font-weight: bold;">Landing Page - Add New Form</a>
        <p>Ready to start creating Landing Pages ? Jump into the Landing Page by clicking the Add new button under the Landing Pages menu.</p>
        <br>
        <br>
        <br>
        <br>
        <div style="float: left; width: 100%;">
          ...
          <a href="http://web-settler.com/ultimate-landing-page-fix-404-page-not-found-error/" target="_blank">How to fix page not found error.</a>
			  </div>
      </div>
